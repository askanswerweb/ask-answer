...
return [
    ...
    "CannotDelete"          => "لا يمكن الحذف؛ يرجى التحقق من ارتباطه بسجلات أخرى!",
    "Username"              => "يجب أن يحتوي اسم المستخدم على احرف او أرقام او شرطة سفلية فقط، وأن يكون 8 خانات على الأقل.",
