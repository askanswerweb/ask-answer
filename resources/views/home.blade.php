                ...
                <div class="card card-flush mb-5">
                    ...
                    <div class="card-body pt-2 pb-0">
                        ...
                        <textarea class="form-control bg-transparent border-0 px-0"
                                  id="kt_social_feeds_post_input" name="message" data-kt-autosize="true"
                    ...
                    <div class="card-footer d-flex justify-content-end pt-0">
                        ...
                        <a href="/metronic8/demo1/../demo1/pages/blog/post.html"
                           class="btn btn-sm btn-primary" id="kt_social_feeds_post_btn">
                        ...
                        <div class="card-header pt-9">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <!--begin::Date-->
                                    <span class="text-gray-400 fw-semibold d-block">Yestarday at 5:06
                                        PM</span>
                                    <!--end::Date-->
                                </div>
                                <!--end::Info-->
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap mb-0">
                                                ...
                                                <!--begin::Date-->
                                                <span class="text-gray-400 fw-semibold fs-7 me-5">1 Day
                                                    ago</span>
                                                <!--end::Date-->
                                            ...
                                            <span class="text-gray-800 fs-7 fw-normal pt-1">Long before
                                                you sit dow to put digital pen to paper you need to make
                                                sure you have to sit down and write.</span>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap mb-0">
                                                ...
                                                <!--begin::Date-->
                                                <span class="text-gray-400 fw-semibold fs-7 me-5">2 Days
                                                    ago</span>
                                                <!--end::Date-->
                                            ...
                                            <!--begin::Text-->
                                            <span class="text-gray-800 fs-7 fw-normal pt-1">Long before
                                                you sit dow to put digital pen to paper</span>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap mb-0">
                                                ...
                                                <!--begin::Date-->
                                                <span class="text-gray-400 fw-semibold fs-7 me-5">3 Days
                                                    ago</span>
                                                <!--end::Date-->
                    ...
                    <div class="card card-flush mb-5">
                        ...
                        <div class="card-header pt-9">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <div
                                        class="symbol-label fs-2 fw-semibold bg-light text-inverse-success">
                                        <i class="ki-duotone ki-file-added fs-2x text-primary"><span
                                                class="path1"></span><span class="path2"></span></i>
                                    </div>
                                ...
                                <ul class="nav py-3">
                                    ...
                                    <li class="nav-item">
                                        <a
                                            class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible "
                                            data-bs-toggle="collapse"
                                            href="#kt_social_feeds_comments_3">
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap mb-0">
                                                ...
                                                <!--begin::Date-->
                                                <span class="text-gray-400 fw-semibold fs-7 me-5">4 Days
                                                    ago</span>
                                                <!--end::Date-->
                                ...
                                <ul class="nav py-3">
                                    ...
                                    <li class="nav-item">
                                        <a
                                            class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible "
                                            data-bs-toggle="collapse"
                                            href="#kt_social_feeds_comments_4">
                                    ...
                                    <div class="d-flex pt-6">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap mb-0">
                                                ...
                                                <!--begin::Date-->
                                                <span class="text-gray-400 fw-semibold fs-7 me-5">5 Days
                                                    ago</span>
                                                <!--end::Date-->
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#"
                                           class="text-gray-800 text-hover-primary fs-4 fw-bold">Stive
                                            Strong</a>
                                        <!--end::Name-->

                                        <!--begin::Date-->
                                        <span class="text-gray-400 fw-semibold d-block">Yestarday at
                                            3:30 PM</span>
                                        <!--end::Date-->
                                    </div>
                                    <!--end::Info-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 g-lg-6">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <!--begin::Img-->
                                        <a href="">
                                            <img src="/assets/media/stock/600x600/img-14.jpg"
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <!--begin::Img-->
                                        <a href="">
                                            <img src="/assets/media/stock/600x600/img-10.jpg"
                                                 class="rounded w-100" alt="" />
                                        </a>
                                        <!--end::Img-->
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <!--begin::Img-->
                                        <a href="">
                                            <img src="/assets/media/stock/600x600/img-18.jpg"
                                                 class="rounded w-100" alt="" />
                                        </a>
                                        <!--end::Img-->
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <!--begin::Img-->
                                        <a href="">
                                            <img src="/assets/media/stock/600x600/img-30.jpg"
                                                 class="rounded w-100" alt="" />
                                        </a>
                                        <!--end::Img-->
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <!--begin::Img-->
                                        <a href="">
                                            <img src="/assets/media/stock/600x600/img-31.jpg"
                                                 class="rounded w-100" alt="" />
                                        </a>
                                        <!--end::Img-->
                                    </div>
                                        ...
                                        <div class="d-flex pt-6">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    ...
                                                    <!--begin::Date-->
                                                    <span class="text-gray-400 fw-semibold fs-7 me-5">1
                                                        Day ago</span>
                                                    <!--end::Date-->
                                                ...
                                                <!--begin::Text-->
                                                <span class="text-gray-800 fs-7 fw-normal pt-1">Long
                                                    before you sit dow to put digital pen to paper you
                                                    need to make sure you have to sit down and
                                                    write.</span>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Wrapper-->
                                        ...
                                        <div class="d-flex pt-6">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    ...
                                                    <!--begin::Date-->
                                                    <span class="text-gray-400 fw-semibold fs-7 me-5">2
                                                        Days ago</span>
                                                    <!--end::Date-->
                                                ...
                                                <!--begin::Text-->
                                                <span class="text-gray-800 fs-7 fw-normal pt-1">Long
                                                    before you sit dow to put digital pen to
                                                    paper</span>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Wrapper-->
                                        ...
                                        <div class="d-flex pt-6">
                                            ...
                                            <div class="d-flex flex-column flex-row-fluid">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-0">
                                                    ...
                                                    <!--begin::Date-->
                                                    <span class="text-gray-400 fw-semibold fs-7 me-5">3
                                                        Days ago</span>
                                                    <!--end::Date-->
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="#"
                                           class="text-gray-800 text-hover-primary fs-4 fw-bold">Lara
                                            Nilson</a>
                                        <!--end::Name-->
                                    ...
                                    <ul class="nav py-3">
                                        ...
                                        <li class="nav-item">
                                            <a
                                                class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible "
                                                data-bs-toggle="collapse"
                                                href="#kt_social_feeds_comments_6">
