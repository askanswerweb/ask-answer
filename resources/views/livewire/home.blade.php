<div id="kt_app_content" class="app-content flex-column-fluid mt-0 pt-1">
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="d-flex-end mb-5">
            ...
            <div class="">
                <!--begin::Menu toggle-->
                <a href="javascript:void(0);" class="btn btn-sm btn-flex btn-secondary fw-bold"
                ...
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                     id="kt_menu_6428b7656273c" style="">
                    <!--begin::Header-->
                    <div class="px-7 py-5">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="d-flex">
                                    <input type="date" value="{{ request('date_from') }}"
                                           name="date_from" class="form-control form-control-solid" />
                                </div>
                            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <div class="d-flex">
                                    <input type="date" value="{{ request('date_to') }}"
                                           name="date_to" class="form-control form-control-solid" />
                                </div>
                            </div>
